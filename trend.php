...
$query1 = "SELECT stock_symbol FROM user_stock";
...
$url2='https://api.havenondemand.com/1/api/sync/trendanalysis/v1';


$filePath = realpath('test.csv');
$post = array(
    'groups_column' => 'month', 
    'compared_group' => 'January', 
    'main_group' => 'March', 
    'columns' => 'change_trend', 
    'apikey' => '8f247f91-9eb9-4791-91d2-d26f7ee9e0f5',
...
if(!is_null($phpObj->trend_collections->trends))
          {
            foreach($phpObj->trend_collections->trends as $trend)
            {  

                echo $trend['trend'];
                $csv_export.= '
';
                echo $trend->measure->value; 
